...
define(["dojo/dom-geometry", "MultiLevelMenu/widget/MenuData", "dojo/window", "dojo/aspect", "dijit/form/TextBox", 
...
require(['MultiLevelMenu/widget/MultiLevelMenu'], function () {
    'use strict';
});